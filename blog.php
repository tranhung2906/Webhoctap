		...
		<div class="container">
				...
				<div class="col">
					<div class="blog_post_container">
						...
						<div class="blog_post trans_200">
							<div class="blog_post_image"><img src="<?php echo str_replace('../', '', $row['image']) ?>" alt=""></div>
							<div class="blog_post_body">
								<div class="blog_post_title"><a href="blogdetail.php?id=<?php echo $row['id'] ?>"><?php echo $row['title'] ?></a></div>
			...
			<div class="row">
				<div class="col text-center">
					<div class="load_more trans_200"><a href="blog.php">Xem thêm</a></div>
				</div>
			</div>
		</div>
	</div>
