...
$idtopic = $_GET['id'];
$truyvan = "SELECT id, name FROM topic WHERE id <> $idtopic";
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Quản lý giảng viên</a></li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Chỉnh sửa giảng viên</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="" method="post" enctype="multipart/form-data">
                                 ...
                                 include "../config/db_connect.php";
                                    if(isset($_GET['id'])){
                                        $id = $_GET['id'];
                                        $sql = "SELECT *, topic.name as topicname FROM topic JOIN lecturer ON topic.id = lecturer.topic_id WHERE lecturer.id = '$id';";
                                 ...
                                 <input type="hidden" name="id" value="<?php echo $row['id']  ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleSelect">Chuyên môn giảng dạy</label>
                                            <select name="chuyenmon" class="form-control" id="exampleSelect">
                                            <option value="<?php echo $row['topic_id'] ?>"><?php echo $row['topicname'] ?></option>
                                            <?php
                                                foreach($arrS as $arr){
                                            ?>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Mô tả giảng viên</label>
                                            <input type="description" name="description" class="form-control" id="exampleInputEmail1" value="<?php echo $row['description']  ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" id="exampleSelect">
                                                <?php if($row['status'] == 1){ ?>
                                                <option selected value="1">Đang giảng dạy</option>
                                                <option value="0">Ngưng giảng dạy</option>
                                                <?php }else{ ?>
                                                    <option selected value="0">Ngưng giảng dạy</option>  
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            $chuyenmon = isset($_POST['chuyenmon']) ? $conn->real_escape_string($_POST['chuyenmon']) : '';
                            ...
                            if ($id > 0) {
                                ...
                                $sql = "UPDATE lecturer 
                                        SET name = '$name', topic_id = '$chuyenmon', description = '$mota', status = $status $updateImage 
                                        WHERE id = $id";
