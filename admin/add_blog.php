                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <form action="add_blog.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="author" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên tác giả">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date" class="form-control" id="exampleInputEmail1" value="<?php echo date('Y/m/d   ');  ?>">
                                        </div>
                                        <div class="form-group">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                            ...
                            $date = $_POST['date'];
                            $sql = "INSERT INTO blog (title, content, author, date, status) VALUES ('$title', '$content', '$author', '$date', '$status')";
                            if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                                ...
                                if (in_array($fileType, $allowedTypes)) {
                                    if (move_uploaded_file($fileTmp, $targetFile)) {
                                        $sql = "INSERT INTO blog (title, content, author, date, image, status) VALUES ('$title', '$content', '$author', '$date', '$targetFile', '$status')";
                                        if ($conn->query($sql) === TRUE) {
                                            $_SESSION['success'] = "Thêm bài viết thành công!";
                                            echo"<script>window.location.href = 'add_blog.php';</script>";
                                        } else {
                                            $_SESSION['error'] = "Lỗi khi thêm bài viết: " . $conn->error;
                                echo"<script>window.location.href = 'add_blog.php';</script>";
                                        }
                                    } else {
