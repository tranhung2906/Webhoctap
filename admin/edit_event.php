                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <form action="edit_menu.php" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tenmenu" class="form-control" id="exampleInputEmail1" value="<?php echo $row['name'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Đường dẫn</label>
                                            <input type="text" name="link" class="form-control" id="exampleInputEmail1" value="<?php echo $row['link'] ?>">
                                        </div>
                                        <div class="form-group">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            $menuName = $_POST['tenmenu'];
                            $menuLink = $_POST['link'];
                            $status = $_POST['status'];
                            $id = $_POST['id'];
                            if (!empty($menuName) && !empty($menuLink)) {
                                $sql = "UPDATE menu SET name = '$menuName', link = '$menuLink', status = '$status' WHERE id = '$id'; ";
