                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <form action="add_topic.php" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên chủ đề">
                                        </div>
                                        <div class="form-group">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if (!empty($name)) {
                                $sql = "INSERT INTO topic (name, status) VALUES ('$name', $status)";
                                if ($conn->query($sql) === TRUE) {
                                    $_SESSION['success'] = "Thêm chủ đề thành công!";
                                    echo"<script>window.location.href = 'add_topic.php';</script>";
                                } else {
