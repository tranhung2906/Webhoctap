...
$truyvan = "SELECT id, name FROM topic WHERE status = 1";
$thucthi = mysqli_query($conn, $truyvan);
while($ketqua = mysqli_fetch_array($thucthi)){
    $arrS [] = $ketqua;
}
//Show giảng viên
$truyvangv = "SELECT id, name FROM lecturer WHERE status = 1";
$tthi = mysqli_query($conn, $truyvangv);
while($ketquagv = mysqli_fetch_array($tthi)){
    $arrG [] = $ketquagv;
}
?>
<!DOCTYPE html>
                ...
                <div class="container-fluid">
                    <div class="row">
                                ...
                                <form action="add_course.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên khóa học">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleSelect">Chủ đề</label>
                                            <select name="topic" class="form-control" id="exampleSelect">
                                            <option>--Chọn chủ đề của khóa học--</option>
                                            <?php 
                                                foreach($arrS as $arr){
                                            ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="lecturer" class="form-control" id="exampleSelect">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" class="form-control" id="exampleInputEmail1" placeholder="Nhập giá tiền khóa học">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="duration" class="form-control" id="exampleInputEmail1" placeholder="Nhập thời gian khóa học">
                                        </div>
                                        <div class="form-group">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            $chude = isset($_POST['topic']) ? $conn->real_escape_string($_POST['topic']) : '';
                            $giatien = isset($_POST['price']) ? $conn->real_escape_string($_POST['price']) : '';
                            $giangvien = isset($_POST['lecturer']) ? $conn->real_escape_string($_POST['lecturer']) : '';
                            $thoigian = isset($_POST['duration']) ? $conn->real_escape_string($_POST['duration']) : '';
                            ...
                            if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                                ...
                                if (in_array($fileType, $allowedTypes)) {
                                    if (move_uploaded_file($fileTmp, $targetFile)) {
                                        $sql = "INSERT INTO course (name, topic_id, teacher_id, description, duration, price,image, status) VALUES ('$name', '$chude', '$giangvien','$mota', '$thoigian', '$giatien','$targetFile', $status)";
