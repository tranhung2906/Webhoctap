                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="edit_slide.php" method="post" enctype="multipart/form-data">
                                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if ($id > 0) {
                                ...
                                $sql = "UPDATE slide 
                                        SET title = '$title', content = '$content', status = $status $updateImage 
                                        WHERE id = $id";
                        
                                if (mysqli_query($conn, $sql)) {
                                    $_SESSION['success'] = "Slide đã được cập nhật thành công!";
                                    echo"<script>window.location.href = 'all_slide.php';</script>";
                                } else {
