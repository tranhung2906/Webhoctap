                                ...
                                <form action="add_slide.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên menu">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nội dung</label>
                                            <input type="text" name="content" class="form-control" id="exampleInputEmail1" placeholder="Nhập đường dẫn">
                                        </div>
                                        <div class="form-group">
                            ...
                            if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                                ...
                                if (in_array($fileType, $allowedTypes)) {
                                    if (move_uploaded_file($fileTmp, $targetFile)) {
                                        $sql = "INSERT INTO slide (title, content, image, status) VALUES ('$title', '$content', '$targetFile', $status)";
                                        if ($conn->query($sql) === TRUE) {
                                            $_SESSION['success'] = "Slide đã thêm thành công!";
